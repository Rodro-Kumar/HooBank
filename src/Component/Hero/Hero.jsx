  ...
  return (
    <>
      <div className="hero">
            ...
            <div className="left">
              ...
              <div className="hero-heading">
                <h1 className="font-poppins text-4xl font-semibold leading-10 pt-2 text-white pb-5 ">
                  The Next <span className="headingSpan">Generation</span>{" "}
                  Payment Method.
                </h1>
              ...
              <div className="getStarted2  border-2 border-[#33BBCF] rounded-full w-[130px] h-[130px] bg-transparent py-[39px] cursor-pointer mt-6 mx-auto">
                <p className="text-[#5CE1E6] text-center">
                  Get
                  <RxArrowTopRight className="inline-block text-white ml-1 text-xl" />
                  <p>Started</p>
        ...
        <div className="container">
          <div className="user text-white  justify-between mt-10">
            <div className="inslight">
              <div className="active flex items-center">
                <p className="text-3xl font-poppins font-semibold text-white user-heading">
                  3800+
                </p>
              ...
              <div className="w-[2px] h-4 bg-[#ffffff93] line"></div>
              <div className="company flex items-center  py-3">
                <p className="text-3xl font-poppins font-semibold text-white user-heading">
                  230+
                </p>
